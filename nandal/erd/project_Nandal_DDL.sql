...
CREATE TABLE "CLASS_PHOTO" (
	"CLASS_CODE"	NUMBER		NOT NULL,
	"CI_ROUTE"	VARCHAR2(100)		NOT NULL,
	"CI_TYPE"	NUMBER(1)		NOT NULL
);
COMMENT ON COLUMN "CLASS_PHOTO"."CI_ROUTE" IS './images/class/파일이름';
COMMENT ON COLUMN "CLASS_PHOTO"."CI_TYPE" IS '0클래스 사진, 1클래스소개 첨부사진';
...
CREATE TABLE "REVIEW" (
	...
	"REVIEW_FACILITIES"	NUMBER(1)		NOT NULL,
...
COMMENT ON COLUMN "REVIEW"."REVIEW_FACILITIES" IS '0~5에 따라 불만족,만족';
...
CREATE TABLE "REVIEW_PHOTO" (
	"REVIEW_CODE"	NUMBER		NOT NULL,
	"RI_ROUTE"	VARCHAR2(100)		NOT NULL
);
COMMENT ON COLUMN "REVIEW_PHOTO"."RI_ROUTE" IS './images/review/파일이름';

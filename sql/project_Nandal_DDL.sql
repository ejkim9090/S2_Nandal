...
CREATE TABLE "CLASS" (
	...
	"CLASS_PRD"	VARCHAR2(1000)		NOT NULL,
	"AREA_CODE"	NUMBER(2)		NOT NULL,
	"CLASS_ADDRESS"	VARCHAR2(300)		NOT NULL,
...
CREATE TABLE "CLASS_APPLY" (
	...
	"CO_CODE"	NUMBER(2)	DEFAULT 0 	NOT NULL,
	"CS_CODE"	NUMBER		NOT NULL
);
...
COMMENT ON COLUMN "CLASS_APPLY"."CO_CODE" IS '0은 미선택';
...
ALTER TABLE "CLASS_APPLY" ADD CONSTRAINT "FK_CLASS_CA_1" FOREIGN KEY (
	"CLASS_CODE"
)
REFERENCES "CLASS" (
	"CLASS_CODE"
